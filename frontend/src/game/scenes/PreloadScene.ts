...
import pickupBombUrl from '../assets/pickup-bomb.svg';
import pickupShieldUrl from '../assets/pickup-shield.svg';
import pickupWeaponUrl from '../assets/pickup-weapon.svg';
...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image(AssetKeys.PickupBomb, pickupBombUrl);
    this.load.image(AssetKeys.PickupShield, pickupShieldUrl);
    this.load.image(AssetKeys.PickupWeapon, pickupWeaponUrl);
